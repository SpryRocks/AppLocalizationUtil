...
namespace System.Resources.NetStandard
{
    ...
    <xsd:schema id=""root"" xmlns="""" xmlns:xsd=""http://www.w3.org/2001/XMLSchema"" xmlns:msdata=""urn:schemas-microsoft-com:xml-msdata"">
        ...
        public string CustomReaderValue { get; set; }
        public string CustomWriterValue { get; set; }
        ...
        private void InitializeWriter()
        {
            ...
            xmlTextWriter.WriteStartElement(ResHeaderStr);
            {
                ...
                xmlTextWriter.WriteStartElement(ValueStr);
                {
                    xmlTextWriter.WriteString(CustomReaderValue ?? MultitargetUtil.GetAssemblyQualifiedName(typeof(ResXResourceReader), typeNameConverter));
                }
                xmlTextWriter.WriteEndElement();
            }
            xmlTextWriter.WriteEndElement();
            xmlTextWriter.WriteStartElement(ResHeaderStr);
            {
                ...
                xmlTextWriter.WriteStartElement(ValueStr);
                {
                    xmlTextWriter.WriteString(CustomWriterValue ?? MultitargetUtil.GetAssemblyQualifiedName(typeof(ResXResourceWriter), typeNameConverter));
                }
                xmlTextWriter.WriteEndElement();
            }
            xmlTextWriter.WriteEndElement();
